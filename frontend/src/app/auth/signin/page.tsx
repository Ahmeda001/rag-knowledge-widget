              ...
              >
                <div className="text-left">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-soot">
                    Log in to manage your AI doc engines, view search analytics, and sync content sources.
                  </p>
                </div>

                {/* Error Banner */}
                {error && (
                  <div className="mt-5 flex items-center gap-2.5 rounded-xl border border-red-500/20 bg-red-50 p-3.5 text-xs font-medium text-red-700">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <div className="mt-1.5 flex items-center gap-2.5 rounded-xl border border-ink/15 bg-white px-3.5 py-2.5 focus-within:border-persimmon focus-within:ring-1 focus-within:ring-persimmon transition-all">
                  ...
                  <div>
                    <div className="flex items-center justify-between">
                      ...
                      <a href="#forgot" className="text-xs font-semibold text-persimmon hover:underline">
                        Forgot password?
                      </a>
                    </div>
                    <div className="mt-1.5 flex items-center gap-2.5 rounded-xl border border-ink/15 bg-white px-3.5 py-2.5 focus-within:border-persimmon focus-within:ring-1 focus-within:ring-persimmon transition-all">
                  ...
                  <div className="flex items-center justify-between pt-1">
                    <label className="flex items-center gap-2.5 cursor-pointer">
                      <input
                        ...
                        className="h-4 w-4 rounded border-ink/20 text-persimmon focus:ring-persimmon"
                      />
                      <span className="text-xs font-medium text-soot">
                ...
                <p className="mt-8 text-center text-sm text-soot">
                  Don’t have a Docsy account?{" "}
                  <Link
                    href="/auth/signup"
